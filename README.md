...
- [Create a new token](#createtokenmint---create-a-new-token-with-metadata)
...
- 🆕 [Make a function that gets accounts of a particular type](#getaccountsfactory---make-a-function-to-get-and-decodes-accounts-of-a-particular-type)
...
const balance = await connection.getTokenAccountBalance({
  ...
  useTokenExtensions, // Optional: Use Token Extensions program instead of classic Token program
});
```
...
- `params`: `Object` - Parameters for getting token balance
  ...
  - `useTokenExtensions`: `boolean` (optional) - Use Token Extensions program instead of classic Token program (default: false)
